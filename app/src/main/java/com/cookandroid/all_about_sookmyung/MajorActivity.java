...
public class MajorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MajorItem_ArrayList.add(new MajorItem("가족자원경영학과", "-", "순헌관 323A호", "-"));
        MajorItem_ArrayList.add(new MajorItem("경영학부", "-", "순헌관 316A호", "-"));
        MajorItem_ArrayList.add(new MajorItem("경제학부", "-", "-", "명신관 3층 중앙 \n명신관 320호 앞 \n명신관 322호 앞 \n명신관 614호 앞"));
        MajorItem_ArrayList.add(new MajorItem("교육학부", "-", "순헌관 921호", "명신관 303호 앞\n명신관 619호 앞\n명신관 619호 맞은편\n새힘관 1층 엘리베이터 옆"));
        MajorItem_ArrayList.add(new MajorItem("글로벌서비스학부", "명신관 623B호", "-", "-"));
        MajorItem_ArrayList.add(new MajorItem("독일언어문화학과", "순헌관 508B호", "순헌관 316B호", "-"));
        MajorItem_ArrayList.add(new MajorItem("문헌정보학과", "순헌관 501A호", "-", "-"));
        MajorItem_ArrayList.add(new MajorItem("미디어학부", "-", "-", "명신관 218AB호 사이\n명신관 317호 앞\n명신관 617호 앞"));
        ...
        MajorItem_ArrayList.add(new MajorItem("소프트웨어학부", "명신관 311A호", "모름", "명신관 4층 중앙\n명신관 4층 신명신"));
        MajorItem_ArrayList.add(new MajorItem("식품영양학과", "-", "순헌관 323B호", "-"));
        MajorItem_ArrayList.add(new MajorItem("역사문화학과", "순헌관 508A호", "순헌관 412호", "명신관 219호 220호 사이 \n명신관 314호 315호 사이 \n명신관 319호 앞"));
        MajorItem_ArrayList.add(new MajorItem("영어영문학부", "-", "-", "명신관 614호 앞 \n명신관 620호 앞"));
        MajorItem_ArrayList.add(new MajorItem("의류학과", "순헌관 510B호", "순헌관 323B호", "-"));
        MajorItem_ArrayList.add(new MajorItem("인공지능공학부", "-", "명신관 513호", "명신관 221호 앞\n명신관 5층 중앙\n명신관 516호 맞은편\n명신관 517호 옆\n명신관 518호 옆\n명신관 526호 옆"));
        MajorItem_ArrayList.add(new MajorItem("일본학과", "순헌관 508D호", "명신관 602호", "명신관 520호 앞"));
        MajorItem_ArrayList.add(new MajorItem("정치외교학과", "-", "순헌관 313호", "명신관 218AB호 사이\n명신관 219호 220호 사이\n명신관 319호 앞\n명신관 5층 중앙"));
        MajorItem_ArrayList.add(new MajorItem("중어중문학부", "순헌관 508C호", "순헌관 311호", "명신관 4층 중앙\n명신관 517호 옆\n명신관 616호 앞\n명신관 621호 앞"));
        MajorItem_ArrayList.add(new MajorItem("한국어문학부", "-", "순헌관 411호", "명신관 6층 중앙"));
